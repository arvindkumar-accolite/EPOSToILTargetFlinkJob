...
<xsl:stylesheet version="2.0"
	...
	<xsl:template match="RIDER_PARENT">
		...
		<COVR_PCESSAGE></COVR_PCESSAGE>
		<COVR_PCESSTRM></COVR_PCESSTRM>
		<COVR_RCESSAGE></COVR_RCESSAGE>
		<COVR_RCESSTRM></COVR_RCESSTRM>
		<COVR_SUMIN></COVR_SUMIN>
		<COVR_INSTPRM></COVR_INSTPRM>
