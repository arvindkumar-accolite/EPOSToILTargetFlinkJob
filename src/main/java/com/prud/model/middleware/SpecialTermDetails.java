...
@JsonPropertyOrder({ "specialTermId", "specialTermParent", "ageRating", "adjustmentDuration", "rateAdjustment",
		"adjustmentCode", "adjustmentPercentage", "reassuranceIndicator", "selectLineOfSubFile" })
