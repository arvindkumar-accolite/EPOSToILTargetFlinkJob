...
@JsonPropertyOrder({ "riderId", "riderParent", "mortalityClass", "premiumCessationAge", "premiumCessationTerm",
		"riskCessationAge", "riskCessationTerm", "sumInsured", "coverageOrRiderInstalmentAmount",
